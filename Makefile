...
update-plutus: export MACOS_BIN_SHA256 := $(call get-manifest-value,darwin-x64,sha256bin)
update-plutus: export MACOS_BIN_URL := $(call get-manifest-value,darwin-x64,bin)
update-plutus: export LINUX_BIN_SHA256 := $(call get-manifest-value,linux-x64,sha256bin)
